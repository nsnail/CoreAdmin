...
public static class LoggerConfigurationExtensions
{
    ...
    public static LoggerConfiguration Init(this LoggerConfiguration me)
    {
        ...
        me.WriteTo.File(".logs/.log", outputTemplate: Strings.TEMP_LOG_OUPUT, rollingInterval: RollingInterval.Day
                      , restrictedToMinimumLevel: LogEventLevel.Warning, encoding: Encoding.UTF8);
